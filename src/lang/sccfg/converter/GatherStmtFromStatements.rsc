...
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\block(sB), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	exs = ();
	actionsFromOtherPaths = emptyAcquireActionsPaths();
	fenv = emptyFlowEnvironment();
	for(stmt <- sB){
		<stmts, env, typesOf, fenvS, actionsInPath, actionsFromOtherPathsS, exsS> = gatherStmtFromStatements(stmt, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	...
	return <stmts, env, typesOf, fenv, actionsInPath, actionsFromOtherPaths, exs>;
}

//break()
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\break(), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts)
	= <stmts, (), (), initializeBreakEnvironment(env), [], initializeAcquireActionsFromBreak(actionsInPath + acquireActions), ()>;
...
//break(str label)
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\break(exp), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	if(exp == "")
		fail;
	assert false : "Labeled statement (break) found!!!";
	return <stmts, (), (), initializeBreakEnvironment(env), [], initializeAcquireActionsFromBreak(actionsInPath + acquireActions), ()>;
}

//continue()
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\continue(), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts)
	= <stmts, (), (), initializeContinueEnvironment(env), [], initializeAcquireActionsFromContinue(actionsInPath + acquireActions), ()>;

//continue(str label)
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\continue(_), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	assert false : "Labeled statement (continue) found!!!";
	return <stmts, (), (), initializeContinueEnvironment(env), [], initializeAcquireActionsFromContinue(actionsInPath + acquireActions), ()>;
}
...
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\if(cond, thenB), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	<stmts, potential, env, typesOf, actionsInPath, exs> = gatherStmtFromExpressions(cond, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	stmts += potential;
	actionsInPath += extractAcquireActions(potential, volatileFields);
	
	<stmts, envOpt, typesOpt, fenv, actionsInPathThen, actionsFromOtherPaths, exsC> = gatherStmtFromStatements(thenB, env, typesOf, volatileFields, acquireActions + actionsInPath, [], stmts);
	exs = mergeExceptions(exs,exsC);
				
	env = mergeNestedEnvironment(env,envOpt);
	typesOf = mergeTypeEnvironment(typesOf, typesOpt);
	
	return <stmts, env, typesOf, fenv, actionsInPath + actionsInPathThen, actionsFromOtherPaths, exs>;
}
...
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\return(exp), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	...
	return <stmts, (), (), initializeReturnEnvironment(env), [], initializeAcquireActionsFromReturn(actionsInPath + acquireActions), exs>;
}

//return()
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\return(), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts)
	= <stmts, (), (), initializeReturnEnvironment(env), [], initializeAcquireActionsFromReturn(actionsInPath + acquireActions), exs>;
...
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement ds:\declarationStatement(d), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	exs = ();
	fenv = emptyFlowEnvironment();
	actionsFromOtherPaths = emptyAcquireActionsPaths();
	top-down-break visit(d) {
		case Expression e : {
			<stmts, _, env, typesOf, actionsInPath, exsE> = gatherStmtFromExpressions(e, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
			exs = mergeExceptions(exs, exsE);
		}
		case Statement s : {
			<stmts, env, typesOf, fenvD, actionsInPath, actionsFromOtherPathsD, exsD> = gatherStmtFromStatements(s, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
			exs = mergeExceptions(exs, exsD);
			fenv = mergeFlow(fenv, fenvD);
			actionsFromOtherPaths = mergeActions(actionsFromOtherPaths, actionsFromOtherPathsD);
		}
	}
	return <stmts, env, typesOf, fenv, actionsInPath, actionsFromOtherPaths, exs>;
}
...
//}
//
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:\while(cond, body), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	<stmts, potential, env, typesOf, actionsInPath, exs> = gatherStmtFromExpressions(cond, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	stmts += potential;
	actionsInPath += extractAcquireActions(potential, volatileFields);
	exs = mergeExceptions(exs, exsC);
	...
	<stmts, env, typesOf, fenvInner, acquireActions, exsC> = gatherStmtFromStatements(body, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	exs = mergeExceptions(exs, exsC);
	env = mergeNestedEnvironment(env, getContinueEnvironment(fenvInner));
	
	
	<stmts, potential, env, typesOf, _, _> = gatherStmtFromExpressions(cond, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	stmts += potential;
...
//\expressionStatement(Expression stmt)
tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement s:expressionStatement(e), map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	<stmts, _, env, typesOf, actionsInPath, exs> = gatherStmtFromExpressions(e, env, typesOf, volatileFields, acquireActions, actionsInPath, stmts);
	return <stmts, env, typesOf, emptyFlowEnvironment(), actionsInPath, emptyAcquireActionsPaths(), exs>;
}
...
//}
//
default tuple[set[Stmt], map[loc, set[loc]], map[loc, TypeSensitiveEnvironment], FlowEnvironment, lrel[loc,loc], AcquireActionsPaths, map[str, ExceptionState]] gatherStmtFromStatements(Statement b, map[loc, set[loc]] env, map[loc, TypeSensitiveEnvironment] typesOf, set[loc] volatileFields, lrel[loc,loc] acquireActions, lrel[loc,loc] actionsInPath, set[Stmt] stmts){
	println("case I do not need : <b>");
	return <stmts, env, typesOf, emptyFlowEnvironment(), actionsInPath, emptyAcquireActionsPaths(), ()>;
}
